...
namespace AltV.Net
{
    public partial class Alt
    {
        ...
        {
            Alt.CoreImpl.CreateMValueBool(out var mValue, value);
        ...
        {
            Alt.CoreImpl.CreateMValueInt(out var mValue, value);
            CoreImpl.Resource.SetExport(key, in mValue);
            mValue.Dispose();
        }
        ...
        {
            Alt.CoreImpl.CreateMValueUInt(out var mValue, value);
        ...
        {
            Alt.CoreImpl.CreateMValueDouble(out var mValue, value);
            CoreImpl.Resource.SetExport(key,mValue);
            mValue.Dispose();
        }
        ...
        {
            Alt.CoreImpl.CreateMValueString(out var mValue, value);
            CoreImpl.Resource.SetExport(key, mValue);
            mValue.Dispose();
        }
        ...
        {
            CoreImpl.SetExport(key, Function.Create(CoreImpl, value));
        }
