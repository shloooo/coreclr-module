...
namespace AltV.Net
{
    public static partial class Alt
    {
        ...
        public static Function OnClient<T1, T2, T3, T4, T5, T6, T7>(string eventName,
            Action<IPlayer, T1, T2, T3, T4, T5, T6, T7> action) => CoreImpl.OnClient(eventName, Function.Create(CoreImpl, action));

        public static Function OnClient<T1, T2, T3, T4, T5, T6, T7, T8>(string eventName,
            Action<IPlayer, T1, T2, T3, T4, T5, T6, T7, T8> action) => CoreImpl.OnClient(eventName, Function.Create(CoreImpl, action));
        ...
        public static Function OnClient<T1, T2, T3, T4, T5, T6, T7>(string eventName,
            Func<IPlayer, T1, T2, T3, T4, T5, T6, T7> action) => CoreImpl.OnClient(eventName, Function.Create(CoreImpl, action));

        public static Function OnClient<T1, T2, T3, T4, T5, T6, T7, T8>(string eventName,
            Func<IPlayer, T1, T2, T3, T4, T5, T6, T7, T8> action) => CoreImpl.OnClient(eventName, Function.Create(CoreImpl, action));
        ...
        public static Function OnceServer(string eventName, Action action) =>
            CoreImpl.OnServer(eventName, Function.Create(CoreImpl, action), true);
        ...
        public static Function OnceServer<T1, T2, T3, T4, T5, T6, T7>(string eventName,
            Action<T1, T2, T3, T4, T5, T6, T7> action) => CoreImpl.OnServer(eventName, Function.Create(CoreImpl, action), true);

        public static Function OnceServer<T1, T2, T3, T4, T5, T6, T7, T8>(string eventName,
            Action<T1, T2, T3, T4, T5, T6, T7, T8> action) => CoreImpl.OnServer(eventName, Function.Create(CoreImpl, action), true);
        ...
        public static Function OnceServer<T1, T2, T3, T4, T5, T6, T7>(string eventName,
            Func<T1, T2, T3, T4, T5, T6, T7> action) => CoreImpl.OnServer(eventName, Function.Create(CoreImpl, action), true);

        public static Function OnceServer<T1, T2, T3, T4, T5, T6, T7, T8>(string eventName,
            Func<T1, T2, T3, T4, T5, T6, T7, T8> action) => CoreImpl.OnServer(eventName, Function.Create(CoreImpl, action), true);
        ...
        public static Function OnceClient(string eventName, Action action) =>
            CoreImpl.OnClient(eventName, Function.Create(CoreImpl, action), true);
        ...
        public static Function OnceClient<T1, T2, T3, T4, T5, T6, T7>(string eventName,
            Action<T1, T2, T3, T4, T5, T6, T7> action) => CoreImpl.OnClient(eventName, Function.Create(CoreImpl, action), true);

        public static Function OnceClient<T1, T2, T3, T4, T5, T6, T7, T8>(string eventName,
            Action<T1, T2, T3, T4, T5, T6, T7, T8> action) => CoreImpl.OnClient(eventName, Function.Create(CoreImpl, action), true);
        ...
        public static Function OnceClient<T1, T2, T3, T4, T5, T6, T7>(string eventName,
            Func<T1, T2, T3, T4, T5, T6, T7> action) => CoreImpl.OnClient(eventName, Function.Create(CoreImpl, action), true);

        public static Function OnceClient<T1, T2, T3, T4, T5, T6, T7, T8>(string eventName,
            Func<T1, T2, T3, T4, T5, T6, T7, T8> action) => CoreImpl.OnClient(eventName, Function.Create(CoreImpl, action), true);
        ...
        public static Function OnceClient<T1, T2, T3, T4, T5, T6, T7>(string eventName,
            Action<IPlayer, T1, T2, T3, T4, T5, T6, T7> action) => CoreImpl.OnClient(eventName, Function.Create(CoreImpl, action), true);

        public static Function OnceClient<T1, T2, T3, T4, T5, T6, T7, T8>(string eventName,
            Action<IPlayer, T1, T2, T3, T4, T5, T6, T7, T8> action) => CoreImpl.OnClient(eventName, Function.Create(CoreImpl, action), true);
        ...
        public static Function OnceClient<T1, T2, T3, T4, T5, T6, T7>(string eventName,
            Func<IPlayer, T1, T2, T3, T4, T5, T6, T7> action) => CoreImpl.OnClient(eventName, Function.Create(CoreImpl, action), true);

        public static Function OnceClient<T1, T2, T3, T4, T5, T6, T7, T8>(string eventName,
            Func<IPlayer, T1, T2, T3, T4, T5, T6, T7, T8> action) => CoreImpl.OnClient(eventName, Function.Create(CoreImpl, action), true);
